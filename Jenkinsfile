        ...
        stage ('Deployments'){
            parallel{
                ...
                stage ("Deploy to Production"){
                    steps {
                        bat "echo y|pscp -i /Users/raugray/Downloads/tomcat-demo.ppk /Program Files (x86)/Jenkins/workspace/FullyAutomated/webapp/target/*.war ec2-user@${params.tomcat_prod}:/var/lib/tomcat7/webapps"
                    }
                }
            }
        }
