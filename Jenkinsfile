        ...
        stage ('Deployments'){
            parallel{
                ...
                stage ("Deploy to Production"){
                    steps {
                        bat "pscp -i /home/jenkins/tomcat-demo.ppk /Program Files (x86)/Jenkins/workspace/FullyAutomated/webapp/target/*.war ec2-user@${params.tomcat_prod}:/var/lib/tomcat7/webapps"
                    }
                }
            }
        }
